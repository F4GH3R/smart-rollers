...
#     rows
#     #|> Enum.reduce(%Fruit{}, fn([pizza_name, pizza_id, _, ingredient_name], struct) -> %{struct | id: pizza_id, name: pizza_name, ingredients: [ingredient_name| struct.ingredients] } )
